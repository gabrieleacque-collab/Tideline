...
export const simpleTheory = {
      ...
      edges: [
        ...
        ["四个名字", "播种、逐浪、筑基、借风不是身份，而是你此刻的收入结构和行动方式。"],
...
export const targetStrategies = {
      plant: {
        nw: { title: "播种者去筑基", text: "你不是要突然变有钱，而是把稳定劳动慢慢沉淀成能替你工作的东西。", steps: ["固定留存比例，先把 6 到 12 个月安全垫做出来。", "把技能收入的一部分转成低维护资产或长期工具。", "减少无复利的加班，把时间换成可复制方法。"] },
        n: { title: "播种者上岸", text: "目标是从单纯劳动转向可积累的职级、资格、作品和组织位置。", steps: ["选择一个能涨价的专业方向，不再平均用力。", "用证书、作品集或关键项目证明你的可替代性下降。", "把收入增长的一半留住，避免生活成本同步膨胀。"] },
        ne: { title: "播种者去借风", text: "你想借速度，但底线不能丢。适合小仓位试风口，而不是押上生活。", steps: ["只拿闲钱和业余时间试新机会。", "每次试错前写清止损线和退出条件。", "保留主收入，不用工资和贷款补高波动亏损。"] },
        w: { title: "播种者入土", text: "你需要更深的确定性：更少波动、更清楚的规则、更稳定的现金流。", steps: ["优先寻找长期合同、稳定岗位或可预测客户。", "砍掉分散项目，集中在一个能持续积累的场景。", "每月复盘留存，而不是只看收入总额。"] },
        c: { title: "播种者守中线", text: "目标不是换人格，而是让稳定底盘更有弹性。", steps: ["保留固定进账，同时每周给新收入留出固定时间。", "把债务压力压到不会影响选择权。", "建立季度复测，观察坐标是否缓慢右移。"] },
        e: { title: "播种者去逐浪", text: "你要从确定劳动走向机会捕获，关键是先有一个小而真实的市场。", steps: ["从一个具体客户群开始，不要泛泛做副业。", "用作品、案例或样品换第一批反馈。", "主业托底，直到项目收入连续 3 个月可重复。"] },
        sw: { title: "播种者回田", text: "这是回到底盘的选择：先保现金流、保健康、保家庭责任。", steps: ["暂停高波动尝试，先把月度支出降下来。", "补足紧急备用金，减少被动跳槽和被迫借钱。", "用技能成长替代短期焦虑。"] },
        s: { title: "播种者深耕", text: "目标是把主动收入做厚，靠技能复利而不是靠运气。", steps: ["选择一个能持续涨价的技能，每周固定投入。", "把成果变成作品集、客户评价或可展示案例。", "每半年只优化一个主变量：时薪、客户质量或留存。"] },
        se: { title: "播种者试潮", text: "适合从稳定底盘出发，试一条可控的项目线。", steps: ["先做低成本试单，验证需求而不是想象市场。", "项目钱先留一半，不立刻扩大开销。", "只在复购出现后再投入更多时间。"] }
      },
      surf: {
        nw: { title: "逐浪者去筑基", text: "你要把一次次捕获固化下来，让机会变成资产和流程。", steps: ["把项目收入分成生活、留存、复投三份。", "把最佳客户和交付流程写成模板。", "减少只靠个人状态才能完成的项目。"] },
        n: { title: "逐浪者上岸", text: "你需要把不稳定机会转成可预测收入。", steps: ["筛选复购客户，放弃只消耗精力的单次项目。", "给报价和交付设置标准，不再每次临场发挥。", "建立现金流表，看未来 3 个月是否站得住。"] },
        ne: { title: "逐浪者去借风", text: "这是从项目捕获走向更高速度，但风险也会放大。", steps: ["只放大已经验证过的渠道，不放大情绪。", "设置单项目亏损上限，避免用下一单补上一单。", "保留一个稳定客户池作为回撤垫。"] },
        w: { title: "逐浪者去播种", text: "你要减少漂移感，把机会收入放进更清楚的规则里。", steps: ["把客户来源固定到 1 到 2 个主渠道。", "把交付周期缩短，减少回款不确定。", "用合同、定金和里程碑保护现金流。"] },
        c: { title: "逐浪者守中线", text: "保持机会敏感，但别让每次浪都改变生活节奏。", steps: ["保留项目弹性，同时固定每月最低留存。", "把高峰收入平滑到 6 个月使用。", "每季度淘汰一个低质量机会来源。"] },
        e: { title: "逐浪者扩海", text: "你适合扩大机会池，但必须靠方法，不靠兴奋。", steps: ["复制最成功的客户画像，寻找相邻市场。", "用公开作品和案例降低获客成本。", "只扩张能复用的部分，不扩张个人疲劳。"] },
        sw: { title: "逐浪者下潜", text: "目标是从波动中撤一层，先回到能稳定呼吸的位置。", steps: ["暂停大项目赌注，先补回现金和睡眠。", "把项目列表按回款确定性排序。", "先做小而快的交付，恢复节奏。"] },
        s: { title: "逐浪者练桨", text: "你要把机会判断背后的技能练实。", steps: ["复盘过去 5 次赚钱，找出真正可复制的动作。", "补一个短板技能：销售、交付、财务或表达。", "让项目能力脱离单次好运。"] },
        se: { title: "逐浪者追潮", text: "这是顺势扩张位，适合已有验证后的连续捕获。", steps: ["围绕一个已验证方向连续做 3 个版本。", "用现金留存控制扩张速度。", "把客户反馈变成下一轮产品或服务。"] }
      },
      build: {
        nw: { title: "筑基者加固", text: "你已经在占有侧，重点是确认资产真的产钱。", steps: ["盘点每项资产扣除维护后的净现金流。", "清理不产现金还占用心力的资产。", "把现金流重新投到更低维护的结构里。"] },
        n: { title: "筑基者收租", text: "目标是提高被动收益质量，而不是堆账面规模。", steps: ["看净收益率，不只看总价。", "降低债务和维护成本对现金流的侵蚀。", "保留流动现金，避免资产重但手里空。"] },
        ne: { title: "筑基者去借风", text: "你想用资产基础去抓速度，但不能把底座抵押掉。", steps: ["只用盈余试高波动机会，不动核心资产。", "为每个机会设置资金上限和时间上限。", "把收益及时撤回底座，而不是无限滚动。"] },
        w: { title: "筑基者封仓", text: "这是防守位：减少外部波动，让资产和责任匹配。", steps: ["重新评估负债期限，避免短债长投。", "提高现金比例，降低被迫卖出的概率。", "把家庭责任纳入资产配置，而不是只看收益。"] },
        c: { title: "筑基者守中线", text: "你需要在稳定和开放之间留一个窗口。", steps: ["保留核心资产，同时拿小比例做新项目观察。", "每季度检查资产是否仍然产现金。", "把稳定收益的一部分用于技能或渠道更新。"] },
        e: { title: "筑基者开窗", text: "你要从资产稳定走向机会开放，让沉睡资源重新流动。", steps: ["用已有资源连接新客户、渠道或合作。", "先做轻资产试验，不急着重投入。", "把一次合作变成长期入口。"] },
        sw: { title: "筑基者去播种", text: "回到劳动侧是为了修复现金流，不是失败。", steps: ["如果资产现金流变薄，先补主动收入。", "减少账面幻觉，关注每月留下的钱。", "用一段稳定工作或服务换回流动性。"] },
        s: { title: "筑基者补工", text: "你需要重新拥有主动赚钱能力，避免只靠资产价格。", steps: ["恢复一个能直接变现的技能。", "用专业服务或顾问收入补现金流。", "不要让身份感压过真实收入。"] },
        se: { title: "筑基者去逐浪", text: "适合用稳资产做后盾，开一条小项目线。", steps: ["选择和现有资产相关的轻项目。", "控制预算，先验证客户和回款。", "成功后再考虑资产化或流程化。"] }
      },
      wind: {
        nw: { title: "借风者去筑基", text: "你要把速度留下来，变成底座，而不是只留下刺激。", steps: ["每次收益先撤出本金和税费。", "把盈利的一部分固定转入安全资产。", "减少杠杆，让风停时还能站住。"] },
        n: { title: "借风者收束", text: "目标是从高波动上方回到可管理的占有结构。", steps: ["列出所有风险敞口，先砍掉最大尾部风险。", "把短期交易收益转成安全储备。", "停止用借来的钱追下一波。"] },
        ne: { title: "借风者冲顶", text: "这是最高速位置，只适合极小仓位和明确止损。", steps: ["每次行动前写清退出价格、时间和亏损上限。", "用组合限制单点失败。", "盈利后立即分层撤退，不把胜利重新押回去。"] },
        w: { title: "借风者去播种", text: "你要把信息差收入接到更稳定的规则和现金流上。", steps: ["寻找能制度化的渠道，而不是只靠快进快出。", "把交易、套利或风口经验整理成服务或流程。", "降低频率，提高确定性。"] },
        c: { title: "借风者守中线", text: "你需要保留敏锐，但把它关进风险笼子里。", steps: ["设定总风险预算，亏完就停。", "每月固定留存，不让账户波动决定生活。", "把一次判断复盘成规则，不靠情绪冲动。"] },
        e: { title: "借风者控帆", text: "你仍在海洋侧，但目标是有控制地借势。", steps: ["只追自己熟悉的风，不追所有风。", "减少杠杆，增加信息验证。", "用小仓位连续试，而不是单次梭哈。"] },
        sw: { title: "借风者降帆", text: "这是止损和回到底线的位置，先活下来。", steps: ["停止加仓和借钱，先确认还能撑多久。", "把债务、保证金和固定支出逐项降下来。", "用稳定现金流修复选择权。"] },
        s: { title: "借风者练底", text: "你需要让爆发力下面长出真实技能。", steps: ["选一个能长期变现的硬技能。", "把过去的判断经验写成可出售的内容或服务。", "先稳定三个月现金流，再谈下一次机会。"] },
        se: { title: "借风者去逐浪", text: "从纯速度转向项目捕获，让高波动变得可复用。", steps: ["把信息差转成客户价值，而不是只做交易。", "寻找可复购场景，让机会变成项目。", "每次项目收益都先补安全储备。"] }
      }
    };
...
export function conclusion(scores) {
      ...
      if (highMismatch) {
        return {
          ...
          notes: [
            "先看每月真正留下的钱：如果权力位置让你留存下降，它就不是资产，而是负担。",
      ...
      return {
        path: d === "播种型" ? "上班攒资产" : d === "逐浪型" ? "项目试水" : d === "筑基型" ? "守资产开窗口" : "小仓位抓机会",
        title: `未来进展：当前主导为${d}`,
        ...
        notes: [
          ...
          "每季度复测一次，看坐标是在往左上固化、右上跃迁，还是向农渔合一移动。"
        ]
      };
    }
